...
import { DynamicSmoothScroll } from '@/components/providers/dynamic-smooth-scroll'
          ...
          <div className="mb-10">
            <Link href="/app">
              ...
              <nav className="flex flex-col items-center gap-4">
                <Link href="/app" className="group relative flex items-center justify-center rounded-lg p-3 text-white">
